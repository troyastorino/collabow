...
function sendStroke(stroke, added) {
  $.ajax({
    type: "POST",
    url: added ? "http://collabow.herokuapp.com/ink/add-stroke" : "http://collabow.herokuapp.com/ink/remove-stroke",
    async: false,
    data: {data: stroke},
...
function clearStrokes() {
  $.ajax({
    type: "POST",
    url: "http://collabow.herokuapp.com/ink/clear-strokes",
    async: false,
    data: {},
    success: function(data) {
      strokes = [];
...
function reloadCanvas() {
  $.ajax({
    type: "GET",
    url: "http://collabow.herokuapp.com/ink/strokes",
    async: false,
    dataType: "json",
    success: function(data) {
      strokes = eval(data);
...
$(document).ready(function() {
  ...
  $("#my-ink canvas").ontouchstart = function() {
    stopReloads = true
  };
});
